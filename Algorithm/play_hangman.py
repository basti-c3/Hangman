...
import re
from Algorithm.get_possible_words import get_same_length_words_considering_dashes, get_possible_words
...
def play_hangman(hangman_word: str, word_list: list[str], max_wrong_guesses: int):
    ...
    same_length_words = get_same_length_words_considering_dashes(hangman_word=hangman_word, word_list=word_list)
